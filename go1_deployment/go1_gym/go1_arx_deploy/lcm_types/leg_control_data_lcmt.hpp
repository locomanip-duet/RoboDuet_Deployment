...
int leg_control_data_lcmt::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->q_arm[0], 7);
    if(tlen < 0) return tlen; else pos += tlen;
...
int leg_control_data_lcmt::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->q_arm[0], 7);
    if(tlen < 0) return tlen; else pos += tlen;
...
{
    uint64_t hash = 0x1ea9b921eed808e5LL;
