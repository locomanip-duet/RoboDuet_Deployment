...
from go2_arx_deploy.lcm_types.pd_tau_targets_lcmt import pd_tau_targets_lcmt
from go2_arx_deploy.utils.cheetah_state_estimator import quat_apply, StateEstimator
from go2_arx_deploy.utils.command_profile import RCControllerProfile
...
class LCMAgent():
    ...
    def plan(self, obs):
        ...
        self.commands_dog[4] = torch.clip(obs[1] * 0.4, -0.2, 0.2)
    ...
    def step(self, actions, hard_reset=False):
        ...
        if (np.linalg.norm(self.commands_dog[:3]) < 0.1):
        ...
        cmds, _ = self.command_profile.get_command(self.timestep * self.dt, probe=self.is_currently_probing)
        ...
        infos = {"joint_pos": self.dof_pos[np.newaxis, :],
                 ...
                 "privileged_obs": None,
                 "cmds_vxyz_lpyrpy": cmds[..., :9][np.newaxis, :],
                 }
